...
public class Tweet : Printable
{
    ...
    init?(data: NSDictionary?) {
        ...
        let z = (data?.valueForKeyPath(TwitterKey.Created) as? String)
        println(z)
...
private extension String {
    var asTwitterDate: NSDate? {
        get {
            ...
            let zzz = "eee MMM dd HH:mm:ss ZZZZ yyyy"
            let yyy = "EEE MMM dd HH:mm:ss Z yyyy"
            let uuu = "EEE MMM dd HH:mm:ss Z yyyy"
